                    ...
                    <div className="text-center pb-12 md:pb-16">
                        ...
                        <div className="max-w-3xl mx-auto">
                            <p
                                ...
                                data-aos-delay="150"
                            >
                                Embark on a Transformative Learning Journey Tailored Just for You — Effortless Progress Tracking, Dynamic Adaptations, Interactive Assessments, and More!
                            </p>
                            <div
